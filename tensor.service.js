...
const DICTIONARY = require('./1-3-temp/vocab.json');
// eslint-disable-next-line import/no-unresolved
const MODEL = require('./1-3-temp/js_export/tfjs/model.json');
...
module.exports = {
  TensorService,
  initTensor: async () => {
    const tensorService = new TensorService('./temp/model.json', );
